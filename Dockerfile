...
# TODO: 依存モジュール整理したい
RUN apt-get update && apt-get install -y unzip git build-essential curl mysql-client libmysqlclient-dev libssl-dev libgmp-dev libssh2-1-dev libgd-dev libgmp-dev libimager-perl libgif-dev libjpeg-dev libpng12-dev libreadline-dev libgd2-xpm-dev libxml2-dev
